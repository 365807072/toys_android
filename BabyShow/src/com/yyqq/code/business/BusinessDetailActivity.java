...
public class BusinessDetailActivity extends Activity {
	...
	private LinearLayout business_to_group;
	...
	private void init(Bundle savedInstanceState) {
		...
		business_to_group = (LinearLayout) findViewById(R.id.business_to_group);
		business_to_group.setOnClickListener(new OnClickListener() {
				...
				new AbStringHttpResponseListener() {
					...
					public void onSuccess(int statusCode, String content) {
						...
						try {
							...
							group_id = json.getJSONObject("data").getString("group_id");
							if(group_id.isEmpty()){
								business_to_group.setVisibility(View.GONE);
							}else{
								business_to_group.setVisibility(View.VISIBLE);
							}
							...
							for(int i = 0 ; i < json.getJSONObject("data").getJSONArray("package").length() ; i++){
								...
								bean.setBusiness_member_price(packageJson.getString("business_member_price"));
		...
		oks.setShareContentCustomizeCallback(new ShareContentCustomizeCallback() {
			...
			public void onShare(Platform platform, ShareParams paramsToShare) {
				if ("Wechat".equals(platform.getName())) {
					...
					paramsToShare
							.setUrl("http://www.meimei.yihaoss.top/share_business.php?business_id="
									+ Business_id + "");
				} else if ("SinaWeibo".equals(platform.getName())) {
					paramsToShare
							.setText(bs_title
									+ "http://www.meimei.yihaoss.top/share_business.php?business_id="
									+ Business_id + "");
					paramsToShare.setImageUrl(bs_img);
				} else if ("QZone".equals(platform.getName())) {
					paramsToShare.setTitle(""); // title微信、QQ空间
					paramsToShare
							.setTitleUrl("http://www.meimei.yihaoss.top/share_business.php?business_id="
									+ Business_id + "");
					...
					paramsToShare.setImageUrl(bs_img);
					paramsToShare
							.setSiteUrl("http://www.meimei.yihaoss.top/share_business.php?business_id="
									+ Business_id + "");
