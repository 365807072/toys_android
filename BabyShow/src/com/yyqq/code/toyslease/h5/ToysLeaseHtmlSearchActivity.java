...
public class ToysLeaseHtmlSearchActivity extends BaseActivity {
	...
	public static ToysLeaseHtmlSearchActivity toysLeaseHtmlSearchActivity;
	...
	protected void initView() {
		...
		webView.loadUrl("http://www.meimei.yihaoss.top/H5/toy_count/search.html?login_user_id="+Config.getUser(ToysLeaseHtmlSearchActivity.this).uid);
		urlList.add("http://www.meimei.yihaoss.top/H5/toy_count/search.html?login_user_id="+Config.getUser(ToysLeaseHtmlSearchActivity.this).uid);		
	}

	@Override
	protected void initData() {
		toysLeaseHtmlSearchActivity = this;
	}
...
//				inputMethodManager.hideSoftInputFromWindow(ToysLeaseHtmlSearchActivity.this.getCurrentFocus().getWindowToken(), 0);  
//			}  
//			
//			Toast.makeText(ToysLeaseHtmlSearchActivity.this, "4567", 3).show();
//			return true;  
//		}  
...
//	}  
	...
	public class JSCallback{
		...
		public void callMethodChangeNumber(String number){
			...
			Toast.makeText(ToysLeaseHtmlSearchActivity.this, "添加成功", 3).show();
			...
			runOnUiThread(new Runnable() {
				...
				public void run() {
					// 保存购物车数量
					ShoppingCartUtils.updateShoppingCartNumber(ToysLeaseHtmlSearchActivity.this, true);
				}
			});
		}
		...
		public void callMethodToLoginPage(){
			Intent intent = new Intent(ToysLeaseHtmlSearchActivity.this, WebLoginActivity.class);
		...
		public String callMethodGetLoginUserId(){
			return Config.getUser(ToysLeaseHtmlSearchActivity.this).uid;
		}
		...
		public String callMethodIsLogin(){
			if(!MyApplication.getVisitor().equals("0")  || Config.getUser(ToysLeaseHtmlSearchActivity.this).uid.equals("")){
				return "0"; // 未登录
			}else{
				return "1"; // 已登陆
			}
		...
		public void callMethodToToysDetail(String toys_id){
			if(null == toys_id || toys_id.equals("") || toys_id.equals("undefined")){
				Toast.makeText(ToysLeaseHtmlSearchActivity.this, "找不到这个玩具哦~", 3).show();
				return;
			}
			Intent intent = new Intent(ToysLeaseHtmlSearchActivity.this, ToysLeaseHtmlDetailActivity.class);
		...
		public void callMethodToToysOrderDetail(String order_id){
			if(null == order_id || order_id.equals("") || order_id.equals("undefined")){
				Toast.makeText(ToysLeaseHtmlSearchActivity.this, "找不到这个订单哦~", 3).show();
				return;
			}
			Intent intent = new Intent(ToysLeaseHtmlSearchActivity.this, ToysLeaseHtmlOrderToysDetailActivity.class);
		...
		public void callMethodToPostDetail(String img_id){
			if(null == img_id || img_id.equals("") || img_id.equals("undefined")){
				Toast.makeText(ToysLeaseHtmlSearchActivity.this, "找不到这个话题哦~", 3).show();
				return;
			}
			Intent intent = new Intent(ToysLeaseHtmlSearchActivity.this, MainItemDetialActivity.class);
		...
		public void showToast(String toastStr) {
			Toast.makeText(ToysLeaseHtmlSearchActivity.this, toastStr+"", Toast.LENGTH_LONG).show();
		}
		...
		public void callMethodToSearch() {
			Intent intent = new Intent(ToysLeaseHtmlSearchActivity.this, ToysLeaseHtmlSearchActivity.class);
			startActivity(intent);
		}
		...
		public void callMethodToInvite() {
			Intent intent = new Intent(ToysLeaseHtmlSearchActivity.this, InviteFriendActivity.class);
			startActivity(intent);
		}
		...
		public void callMethodFinish(){
			ToysLeaseHtmlSearchActivity.this.finish();
		}
		...
		public void callMethodToWeb(String url){
			Intent intent = new Intent(ToysLeaseHtmlSearchActivity.this, MainItemDetialWebActivity.class);
		...
		public void callMethodToCategory(String category_id){
			Intent intent = new Intent(ToysLeaseHtmlSearchActivity.this, ToysLeaseHtmlCategoryActivity.class);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		 if ((keyCode == KeyEvent.KEYCODE_BACK) && webView.canGoBack()) {
			...
			if(urlList.size() > 1 ){
				if(urlList.get(urlList.size()-1).contains("http://www.meimei.yihaoss.top/H5/toy_count/search.html")){
					 finishThisPage();
