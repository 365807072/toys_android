		...
		oks.setShareContentCustomizeCallback(new ShareContentCustomizeCallback() {
			...
			public void onShare(Platform platform, ShareParams paramsToShare) {
				if ("Wechat".equals(platform.getName())) {
					...
					paramsToShare.setUrl("http://www.meimei.yihaoss.top/fenxiang/postbardetial.html?" + "img_id=" + share_imgId + "&user_id="
									+ share_userId);
				} else if ("SinaWeibo".equals(platform.getName())) {
					paramsToShare.setText(share_title
							+ "http://www.meimei.yihaoss.top/fenxiang/postbardetial.html?"
					...
					paramsToShare
							.setTitleUrl("http://www.meimei.yihaoss.top/fenxiang/postbardetial.html?"
									+ "img_id="
									+ share_imgId
									+ "&user_id="
									+ share_userId);
					...
					paramsToShare
							.setSiteUrl("http://www.meimei.yihaoss.top/fenxiang/postbardetial.html?"
									+ "img_id="
									+ share_imgId
									+ "&user_id="
					...
					paramsToShare
							.setUrl("http://www.meimei.yihaoss.top/fenxiang/postbardetial.html?"
									+ "img_id=" + share_imgId + "&user_id="
									+ share_userId);
				}
