...
public class SelectTimeView extends View {
	 ...
	 * @return
	 */
	public SelectTimeView fontColor(int fontColor) {
	 ...
	 * @return
	 */
	public SelectTimeView fontSize(int fontSize) {
	 ...
	 * @return
	 */
	public SelectTimeView padding(int padding) {
	 ...
	 * @return
	 */
	public SelectTimeView selectTip(String selectTip) {
	 ...
	 * @return
	 */
	public SelectTimeView lists(List<String> lists) {
	 ...
	 * @return
	 */
	public SelectTimeView showCount(int showCount) {
		if (showCount % 2 == 0) {
	 ...
	 * @return
	 */
	public SelectTimeView select(int select) {
		this.select = select;
		return this;
	}
	 ...
	 * @return
	 */
	public SelectTimeView listener(OnSelectTimeViewItemSelectListener listener) {
