...
public class AbRequestParams
{
    ...
    private HttpEntity createMultipartEntity(AbHttpResponseListener responseListener) throws IOException
    {
        ...
        // Add string params
        mHashMapEntryList = new ArrayList<Map.Entry<String,String>>(urlParams.entrySet());
...
//        });
        ...
        {
            entity.addPart(mHashMapEntryList.get(i).getKey(),mHashMapEntryList.get(i).getValue());
        }
        // Add file params
