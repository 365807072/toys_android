...
public class WebLoginActivity extends Activity {
	...
	public static String SEND_MASSAGE_KEY = "send_massage_key";
	public static boolean isSendMassage = false;
	...
	private void initView(){
		if(getIntent().hasExtra(SEND_MASSAGE_KEY)){
			isSendMassage = getIntent().getBooleanExtra(SEND_MASSAGE_KEY, false);
		}else{
			isSendMassage = false;
		}
