...
import com.yyqq.commen.model.ScrollOverListView.OnScrollOverListener;
...
//		if(MainToysHomeActivity.TO_CHANGE_TITLE){
//			if(null !=  MainToysHomeActivity.search_root){
//				MainToysHomeActivity.search_root.setVisibility(View.GONE);
//			}
//		}
...
//		}
	...
	/** 显示头部 使用下拉更新下面有一个view **/
	public void setShowHeaderLayout(View view) {
		mListView.mRelativeLayout.setVisibility(View.VISIBLE);
		mListView.mRelativeLayout.addView(view);

	}
	/** 显示头部 使用下拉更新下面有一个view **/
	public void setShowHeaderLayout(View view,int headContentHeight) {
		mListView.mRelativeLayout.setVisibility(View.VISIBLE);
		mListView.mRelativeLayout.addView(view);
