...
public class MessageFriendList extends Activity implements OnPullDownListener {
				...
				public void onClick(View v) {
					...
					if ("11".equals(item.point) || "12".equals(item.point)
						...
						if(!TextUtils.isEmpty(item.video_url)){
							...
							intent.putExtra("is_post", item.is_post);
						}
...
//		android.util.Log.e(TAG, ServerMutualConfig.ListingFriendsMessage + "&"
//				+ params.toString());
		ab.get(ServerMutualConfig.ListingFriendsMessage + "&" + params.toString(),
	...
	public void onMore() {
		...
		// android.util.Log.e("fanfan1", ServerMutualConfig.ListingFriendsMessage + "&"
		// + params.toString());
		ab.get(ServerMutualConfig.ListingFriendsMessage + "&" + params.toString(),
				new AbStringHttpResponseListener() {
					@Override
