...
public class ToysLeaseHtmlMainAllActivity extends BaseActivity {
	...
	public static ToysLeaseHtmlMainAllActivity toysLeaseHtmlMainAllActivity = null;
	...
	protected void initView() {
		...
		webView.setWebViewClient(new WebViewClient() { 
			...
			public void onReceivedError(WebView view, int errorCode,
				...
				showUpdatePage();
//				Toast.makeText(ToysLeaseHtmlMainAllActivity.this, "抱歉！找不到这个网页", Toast.LENGTH_SHORT).show();
			}
			
		});
		
		webView.loadUrl("http://www.meimei.yihaoss.top/H5/toy_count/all.html?login_user_id="+Config.getUser(ToysLeaseHtmlMainAllActivity.this).uid+"&category_id=0");
		urlList.add("http://www.meimei.yihaoss.top/H5/toy_count/all.html?login_user_id="+Config.getUser(ToysLeaseHtmlMainAllActivity.this).uid+"&category_id=0");
		
	}

	@Override
	protected void initData() {
		toysLeaseHtmlMainAllActivity = this;
...
//		}
	...
	public class JSCallback{
		...
		public void callMethodToLoginPage(){
			Intent intent = new Intent(ToysLeaseHtmlMainAllActivity.this, WebLoginActivity.class);
		...
		public String callMethodGetLoginUserId(){
			return Config.getUser(ToysLeaseHtmlMainAllActivity.this).uid;
		}
		...
		public String callMethodIsLogin(){
			if(!MyApplication.getVisitor().equals("0")  || Config.getUser(ToysLeaseHtmlMainAllActivity.this).uid.equals("")){
				return "0"; // 未登录
			}else{
				return "1"; // 已登陆
			}
		...
		public void callMethodToToysList(String toys_type){
			if(null == toys_type || toys_type.equals("") || toys_type.equals("undefined")){
				Toast.makeText(ToysLeaseHtmlMainAllActivity.this, "找不到这组玩具哦~", 3).show();
				return;
			}
...
//			startActivity(intent);
		...
		public void callMethodToToysDetail(String toys_id){
			if(null == toys_id || toys_id.equals("") || toys_id.equals("undefined")){
				Toast.makeText(ToysLeaseHtmlMainAllActivity.this, "找不到这个玩具哦~", 3).show();
				return;
			}
			Intent intent = new Intent(ToysLeaseHtmlMainAllActivity.this, ToysLeaseHtmlDetailActivity.class);
		...
		public void callMethodToToysOrderDetail(String order_id){
			if(null == order_id || order_id.equals("") || order_id.equals("undefined")){
				Toast.makeText(ToysLeaseHtmlMainAllActivity.this, "找不到这个订单哦~", 3).show();
				return;
			}
			Intent intent = new Intent(ToysLeaseHtmlMainAllActivity.this, ToysLeaseHtmlOrderToysDetailActivity.class);
		...
		public void callMethodToPostDetail(String img_id){
			if(null == img_id || img_id.equals("") || img_id.equals("undefined")){
				Toast.makeText(ToysLeaseHtmlMainAllActivity.this, "找不到这个话题哦~", 3).show();
				return;
			}
			Intent intent = new Intent(ToysLeaseHtmlMainAllActivity.this, MainItemDetialActivity.class);
		...
		public void showToast(String toastStr) {
			Toast.makeText(ToysLeaseHtmlMainAllActivity.this, toastStr, Toast.LENGTH_LONG).show();
		}
		...
		public void callMethodToSearch() {
			Intent intent = new Intent(ToysLeaseHtmlMainAllActivity.this, ToysLeaseHtmlSearchActivity.class);
			startActivity(intent);
		}
		...
		public void callMethodToInvite() {
			Intent intent = new Intent(ToysLeaseHtmlMainAllActivity.this, InviteFriendActivity.class);
			startActivity(intent);
		}
		...
		public void callMethodChangeNumber(String number){
			Toast.makeText(ToysLeaseHtmlMainAllActivity.this, "添加成功", 3).show();
			
			runOnUiThread(new Runnable() {
				
				@Override
				public void run() {
					ShoppingCartUtils.updateShoppingCartNumber(ToysLeaseHtmlMainAllActivity.this, true);
				}
			});
...
//			});
	...
	private void finishThisPage(){
		 ToysLeaseHtmlMainAllActivity.this.finish();
	}
