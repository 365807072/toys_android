 ...
 * lyl
 * */
public class PhoneAlbumDetialActivity extends Activity {
	...
	private Handler mHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case 0:
				Toast.makeText(PhoneAlbumDetialActivity.this,
...
//					Config.showProgressDialog(context, false, null);
					...
					if (!TextUtils.isEmpty(getIntent().getStringExtra("tag"))) {
						...
						if ("isPostBar".equals(getIntent()
								.getStringExtra("tag"))) {
							intent = new Intent(PhoneAlbumDetialActivity.this,
							...
							intent = new Intent(PhoneAlbumDetialActivity.this, BuyShow.class);
							...
							intent = new Intent(PhoneAlbumDetialActivity.this, AddNewToysLeaseActivity.class);
							...
							intent = new Intent(PhoneAlbumDetialActivity.this, VideoDetialActivity.class);
						...
						PhoneAlbumDetialActivity.this.finish();
					} else {
						Config.SELECTEDIMAGECOUNT = getIntent().getIntExtra(
								Config.SELECTNAME, 10);
						uploadImage(i);
	...
	private void initView() {
		...
		adapter = new ImageGridAdapter(PhoneAlbumDetialActivity.this, dataList,
				mHandler);
