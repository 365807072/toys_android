...
//	private WebView search_webView;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		startActivity(new Intent(ToysLeaseSearchActivity.this, SearchMainActivity.class));
		this.finish();
	}
...
//		search_webView.loadUrl("http://www.meimei.yihaoss.top/H5/toy/search_activity.html");
...
//		searchAdapter = new ToysLeaseAllAdapter(ToysLeaseSearchActivity.this, inflater, MyApplication.getInstance(), data, 0, ab);
...
//					Intent intent = new Intent(ToysLeaseSearchActivity.this, ToysLeaseMainShoppingCartActivity.class);
