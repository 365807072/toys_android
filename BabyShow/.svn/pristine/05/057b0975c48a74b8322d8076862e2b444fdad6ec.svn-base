...
public class PostGongGaoActivity extends Activity implements OnPullDownListener {

	private Activity context;
	private String TAG = "fanfan_PostGongGaoActivity";
	...
	private void init() {
		...
		if ("1".equals(distinguish)) {
			post_title.setText("公告");
		} else {
			post_title.setText("精华");
		}
	...
	public void onRefresh() {
		...
		params.put("group_type", distinguish);
		params.put("group_id", groupId);
		// Log.e(TAG,
		// ServerMutualConfig.NoticeRecGroupList + "&" + params.toString());
		ab.setTimeout(5000);
		ab.get(ServerMutualConfig.NoticeRecGroupList + "&" + params.toString(),
