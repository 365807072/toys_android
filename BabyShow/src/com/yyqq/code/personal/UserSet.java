...
public class UserSet extends Activity {
	private String fuwuTxt = "重要须知\n自由环球在此特别提醒用户认真阅读、充分理解本《服务协议》（下称《协议》）\n" +
			...
			"一、使用规则\n" +
			"\n" +
			"    1、用户充分了解并同意，自由环球自由环球租赁仅为用户提供信息分享、传送及获取的平台，用户必须为自己注册账号下的一切行为负责，包括您所传送的任何内容以及由此产生的任何结果。用户应对自由环球自由环球租赁中的内容自行加以判断，并承担因使用内容而引起的所有风险，包括因对内容的正确性、完整性或实用性的依赖而产生的风险。自由环球公司无法且不会对因用户行为而导致的任何损失或损害承担责任。\n" +
			"    2、用户在自由环球自由环球租赁服务中或通过自由环球自由环球租赁服务所传送的任何内容并不反映自由环球公司的观点或政策，自由环球公司对此不承担任何责任。\n" +
			"    3、用户充分了解并同意，自由环球自由环球租赁是一个基于用户关系网的点对点即时通讯产品，用户须对在自由环球自由环球租赁上的注册信息的真实性、合法性、有效性承担全部责任，用户不得冒充他人；不得利用他人的名义传播任何信息；不得恶意使用注册账号导致其他用户误认；否则自由环球公司有权立即停止提供服务，收回自由环球自由环球租赁账号并由用户独自承担由此而产生的一切法律责任。\n" +
			...
			"    8、自由环球公司可依其合理判断，对违反有关法律法规或本协议约定；或侵犯、妨害、威胁任何人权利或安全的内容，或者假冒他人的行为，自由环球公司有权依法停止传输任何前述内容，并有权依其自行判断对违反本条款的任何人士采取适当的法律行动，包括但不限于，从自由环球自由环球租赁服务中删除具有违法性、侵权性、不当性等内容，终止违反者的成员资格，阻止其使用自由环球自由环球租赁全部或部分服务，并且依据法律法规保存有关信息并向有关部门报告等。\n" +
			"    9、用户权利及义务：\n" +
			"        (1) 自由环球自由环球租赁账号的所有权归自由环球公司所有，用户完成申请注册手续后，获得自由环球自由环球租赁账号的使用权，该使用权仅属于初始申请注册人，禁止赠与、借用、租用、转让或售卖。自由环球公司因经营需要，有权回收用户的自由环球自由环球租赁账号。\n" +
			"        (2) 用户有权更改、删除在自由环球自由环球租赁上的个人资料、注册信息及传送内容等，但需注意，删除有关信息的同时也会删除任何您储存在系统中的文字和图片。用户需承担该风险。\n" +
			"        (3) 用户有责任妥善保管注册账号信息及账号密码的安全，用户需要对注册账号以及密码下的行为承担法律责任。用户同意在任何情况下不使用其他成员的账号或密码。在您怀疑他人在使用您的账号或密码时，您同意立即通知自由环球公司。\n" +
			"        (4) 用户应遵守本协议的各项条款，正确、适当地使用本服务，如因用户违反本协议中的任何条款，自由环球公司有权依据协议终止对违约用户自由环球自由环球租赁账号提供服务。同时，自由环球保留在任何时候收回自由环球自由环球租赁账号、用户名的权利。\n" +
			"        (5) 用户注册自由环球自由环球租赁账号后如果长期不登录该账号，自由环球有权回收该账号，以免造成资源浪费，由此带来问题均由用户自行承担。\n" +
			"\n" +
			"二、隐私保护\n" +
			"\n" +
			"    用户同意个人隐私信息是指那些能够对用户进行个人辨识或涉及个人通信的信息，包括下列信息：用户真实姓名，身份证号，手机号码，IP地址。而非个人隐私信息是指用户对本服务的操作状态以及使用习惯等一些明确且客观反映在自由环球服务器端的基本记录信息和其他一切个人隐私信息范围外的普通信息；以及用户同意公开的上述隐私信息；尊重用户个人隐私信息的私有性是自由环球的一贯制度，自由环球将会采取合理的措施保护用户的个人隐私信息，除法律或有法律赋予权限的政府部门要求或用户同意等原因外，自由环球未经用户同意不向除合作单位以外的第三方公开、 透露用户个人隐私信息。 但是，用户在注册时选择同意，或用户与自由环球及合作单位之间就用户个人隐私信息公开或使用另有约定的除外，同时用户应自行承担因此可能产生的任何风险，自由环球对此不予负责。同时，为了运营和改善自由环球的技术和服务，自由环球将可能会自行收集使用或向第三方提供用户的非个人隐私信息，这将有助于自由环球向用户提供更好的用户体验和提高自由环球的服务质量。用户同意，在使用自由环球自由环球租赁服务时也同样受自由环球隐私政策的约束。当您接受本协议条款时，您同样认可并接受自由环球公司隐私政策的条款。\n" +
			"\n" +
			"三、自由环球自由环球租赁商标信息\n" +
			"\n" +
			"    自由环球自由环球租赁服务中所涉及的图形、文字或其组成，以及其他自由环球标志及产品、服务名称，均为自由环球公司之商标（以下简称“自由环球标识”）。未经自由环球事先书面同意，用户不得将自由环球标识以任何方式展示或使用或作其他处理，也不得向他人表明您有权展示、使用、或其他有权处理自由环球标识的行为。\n" +
			"\n" +
			"四、法律责任及免责\n" +
			"\n" +
			...
			"    5、用户须明白，使用本服务因涉及Internet服务，可能会受到各个环节不稳定因素的影响。因此，本服务存在因不可抗力、计算机病毒或黑客攻击、系统不稳定、用户所在位置、用户关机以及其他任何技术、互联网络、通信线路原因等造成的服务中断或不能满足用户要求的风险。用户须承担以上风险，自由环球公司不作担保。对因此导致用户不能发送和接受阅读信息、或接发错信息，自由环球公司不承担任何责任。\n" +
			"    6、用户须明白，在使用本服务过程中存在有来自任何他人的包括威胁性的、诽谤性的、令人反感的或非法的内容或行为或对他人权利的侵犯（包括知识产权）的匿名或冒名的信息的风险，用户须承担以上风险，自由环球公司和合作公司对本服务不作任何类型的担保，不论是明确的或隐含的，包括所有有关信息真实性、适商性、适于某一特定用途、所有权和非侵权性的默示担保和条件，对因此导致任何因用户不正当或非法使用服务产生的直接、间接、偶然、特殊及后续的损害，不承担任何责任。\n" +
			"    7、自由环球公司定义的信息内容包括：文字、软件、声音、相片、录像、图表；在广告中全部内容；自由环球公司为用户提供的商业信息，所有这些内容受版权、商标权、和其它知识产权和所有权法律的保护。所以，用户只能在自由环球公司和广告商授权下才能使用这些内容，而不能擅自复制、修改、编纂这些内容、或创造与内容有关的衍生产品。\n" +
			"    8、在任何情况下，自由环球公司均不对任何间接性、后果性、惩罚性、偶然性、特殊性或刑罚性的损害，包括因用户使用自由环球自由环球租赁而遭受的利润损失，承担责任（即使自由环球自由环球租赁已被告知该等损失的可能性亦然）。尽管本协议中可能含有相悖的规定，自由环球公司对您承担的全部责任，无论因何原因或何种行为方式，始终不超过您在成员期内因使用自由环球自由环球租赁而支付给自由环球公司的费用(如有) 。\n" +
			"\n" +
			"五、自由环球租赁社区管理规则\n" +
			"\n" +
			...
			"    如用户违反社区管理规则，自由环球公司有权依据协议终止对违约用户自由环球自由环球租赁账号提供服务。同时，自由环球保留在任何时候收回自由环球租赁账号的权力。\n" +
			"\n" +
			"六、其他条款\n" +
			"\n" +
			"    1、自由环球公司郑重提醒用户注意本《协议》中免除自由环球公司责任和加重用户义务的条款，请用户仔细阅读，自主考虑风险。未成年人应在法定监护人的陪同下阅读本《协议》。以上各项条款内容的最终解释权及修改权归自由环球公司所有。\n" +
