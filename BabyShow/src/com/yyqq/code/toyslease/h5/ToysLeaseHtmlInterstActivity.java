 ...
 * 
 * */
public class ToysLeaseHtmlInterstActivity extends BaseActivity {
	...
	public static ToysLeaseHtmlInterstActivity toysLeaseHtmlInterstActivity = null;
	...
	protected void initView() {
		Config.showProgressDialog(ToysLeaseHtmlInterstActivity.this, false, null);
		...
		webView.loadUrl("https://api.meimei.yihaoss.top/H5/toy_count/bespeak.html?login_user_id="
				+ Config.getUser(ToysLeaseHtmlInterstActivity.this).uid + "&category_id="
	...
	public class JSCallback {
		...
		public void callMethodToLoginPage() {
			Intent intent = new Intent(ToysLeaseHtmlInterstActivity.this, WebLoginActivity.class);
		...
		public String callMethodGetLoginUserId() {
			return Config.getUser(ToysLeaseHtmlInterstActivity.this).uid;
		}
		...
		public String callMethodIsLogin() {
			if (!MyApplication.getVisitor().equals("0")
					|| Config.getUser(ToysLeaseHtmlInterstActivity.this).uid.equals("")) {
				return "0"; // 未登录
			} else {
				return "1"; // 已登陆
			}
		...
		public void callMethodToToysList(String toys_type) {
			if (null == toys_type || toys_type.equals("") || toys_type.equals("undefined")) {
				Toast.makeText(ToysLeaseHtmlInterstActivity.this, "找不到这组玩具哦~", 3).show();
				return;
			}
		...
		public void callMethodToToysDetail(String toysID) {
			if (null == toysID || toysID.equals("") || toysID.equals("undefined")) {
				Toast.makeText(ToysLeaseHtmlInterstActivity.this, "找不到这件玩具哦~", 3).show();
				return;
			}
			 Intent intent = new Intent(ToysLeaseHtmlInterstActivity.this, ToysLeaseDetailActivity.class);
		...
		public void callMethodToPostDetail(String img_id) {
			if (null == img_id || img_id.equals("") || img_id.equals("undefined")) {
				Toast.makeText(ToysLeaseHtmlInterstActivity.this, "找不到这个话题哦~", 3).show();
				return;
			}
			Intent intent = new Intent(ToysLeaseHtmlInterstActivity.this, MainItemDetialActivity.class);
		...
		public void showToast(String toastStr) {
			Toast.makeText(ToysLeaseHtmlInterstActivity.this, toastStr, Toast.LENGTH_LONG).show();
		}
		...
		public void callMethodToSearch() {
			Intent intent = new Intent(ToysLeaseHtmlInterstActivity.this, ToysLeaseSearchActivity.class);
			startActivity(intent);
		}
		...
		public void callMethodToInvite() {
			Intent intent = new Intent(ToysLeaseHtmlInterstActivity.this, InviteFriendActivity.class);
			startActivity(intent);
		}
		...
		public void callMethodFinish() {
			ToysLeaseHtmlInterstActivity.this.finish();
		}
		...
		public void callMethodToWeb(String url) {
			Intent intent = new Intent(ToysLeaseHtmlInterstActivity.this, MainItemDetialWebActivity.class);
