...
public class PushSet {
	...
	public void setAliasTag(String alias, String tag) {
		...
		// 调用JPush API设置Tag
		mHandler.sendMessage(mHandler.obtainMessage(MSG_SET_TAGS_ALIAS, alias));
	}
	...
	private final TagAliasCallback mAliasCallback = new TagAliasCallback() {
		...
		public void gotResult(int code, String alias, Set<String> tags) {
			...
			case 6002:
				...
				if (JpushUtil.isConnected(mContext.getApplicationContext())) {
...
//			JpushUtil.showToast(logs, mContext.getApplicationContext());
		}
...
//			JpushUtil.showToast(logs, mContext.getApplicationContext());
	...
	private static final int MSG_SET_TAGS_ALIAS = 1003;
