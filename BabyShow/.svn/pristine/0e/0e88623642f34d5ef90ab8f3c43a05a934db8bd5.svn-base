...
public class PostReviewList extends Activity implements OnPullDownListener {
	public String tag = "ReviewList";
	...
	public OnClickListener reviewClick = new OnClickListener() {
		...
		public void onClick(View v) {
			if (edit_review.getText().toString().trim().length() > 0) {
				...
				params.put("review_id", owner_id); // 秀秀id
				params.put("demand", edit_review.getText().toString().trim()); // 评论或者回复评论的内容
				// android.util.Log.e("fanfan_params",params.toString());
		...
		public void onClick(View v) {
			if (custom_face_layout.view.getVisibility() == View.VISIBLE) {
				...
				((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE))
						.hideSoftInputFromWindow(PostReviewList.this
	...
	public void onRefresh() {
		...
		params.put("review_id", owner_id);
		// android.util.Log.e("fanfan", ServerMutualConfig.PostReviewList + "&"
		// + params.toString());
		ab.get(ServerMutualConfig.PostReviewList + "&" + params.toString(),
				new AbStringHttpResponseListener() {
					@Override
					public void onSuccess(int statusCode, String content) {
						super.onSuccess(statusCode, content);
						...
						builder.setNegativeButton("删除",
								new DialogInterface.OnClickListener() {
									...
									public void onClick(DialogInterface dialog,
										...
										fh.post(ServerMutualConfig.DelPostReview,
												params,
