...
public class GroupManagerTopicEditEssenceAdapter extends BaseAdapter {

	private String group_id = "";
	private Activity context = null;
	private LayoutInflater inflater = null;
	private AbHttpUtil ab;
	private ArrayList<GroupManagerTopicBean.Essence> groupManagerTopicBeanist;

	public GroupManagerTopicEditEssenceAdapter(String group_id, Activity context, LayoutInflater inflater, ArrayList<GroupManagerTopicBean.Essence> groupManagerTopicBeanist, AbHttpUtil ab) {
		super();
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		item_group_topic_title.setText(groupManagerTopicBeanist.get(position).getEssence_name());
		
		ImageView item_group_topic_delete = (ImageView) convertView.findViewById(R.id.item_group_topic_delete);
		if(groupManagerTopicBeanist.get(position).getEssence_state().equals("1")){
