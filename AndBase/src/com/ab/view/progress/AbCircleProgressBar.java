...
/**
 * Copyright (c) 2012 All rights reserved 名称：AbCircleProgressBar.java 描述：环形的ProgressBar
 * 
 * @author zhaoqp
...
//    private int[] arcColors = new int[]{0xFF02C016, 0xFF3DF346, 0xFF40F1D5, 0xFF02C016};
    ...
    private int[] arcColors = new int[]{0xFF4BC1D2, 0xFF4BC1D2, 0xFF4BC1D2, 0xFF4BC1D2};
    private int[] shadowsColors = new int[]{0xFF111111, 0x00AAAAAA, 0x00AAAAAA};
    // 灰色轨迹
//    private int pathColor = 0xFF4BC1D2;
    private int pathColor = 0xFFFFFFFF;
    private int pathBorderColor = 0xFFFFFFFF;
    // 环的路径宽度
    ...
    protected void onDraw(Canvas canvas)
    {
        ...
        canvas.drawCircle(this.width / 2,this.height / 2,radius - pathWidth / 2 - 0.5f,pathPaint);
        /*
         * int[] gradientColors = new int[3]; gradientColors[0] = Color.GREEN; gradientColors[1] = Color.YELLOW; gradientColors[2] = Color.RED; float[] gradientPositions = new float[3]; gradientPositions[0] = 0.0f; gradientPositions[1] = 0.5f; gradientPositions[2] = 1.0f; //按颜色比例圆形填充 RadialGradient radialGradientShader = new RadialGradient(this.width/2,this.height/2, radius, gradientColors, gradientPositions, TileMode.CLAMP); paint1.setShader(radialGradientShader);
         */
        // 环形颜色填充
