		...
		oks.setShareContentCustomizeCallback(new ShareContentCustomizeCallback() {
			...
			public void onShare(Platform platform, ShareParams paramsToShare) {
				if ("Wechat".equals(platform.getName())) {
					...
					paramsToShare
							.setUrl("http://www.meimei.yihaoss.top/share_diary.php?user_id="
									+ uid
									+ "&album_id="
					...
					paramsToShare
							.setText(babyName
									...
									+ ": "
									+ grow_title
									+ "http://www.meimei.yihaoss.top/share_diary.php?user_id="
									+ uid + "&album_id="
									+ getIntent().getStringExtra("album_id")
									+ "&baby_id="
									+ getIntent().getStringExtra("baby_id"));
					...
					paramsToShare
							.setTitleUrl("http://www.meimei.yihaoss.top/share_diary.php?user_id="
									+ uid
									+ "&album_id="
									+ getIntent().getStringExtra("album_id")
									+ "&baby_id="
					...
					paramsToShare
							.setSiteUrl("http://www.meimei.yihaoss.top/share_diary.php?user_id="
									+ uid
									+ "&album_id="
									+ getIntent().getStringExtra("album_id")
									+ "&baby_id="
...
//		oks.setNotification(R.drawable.icon, getString(R.string.app_name)); // 分享时Notification的图标和文字
		...
		oks.setCustomerLogo(collect, label, listener);
		oks.setCustomerLogo(collect1, label1, listener1);
		oks.setShareContentCustomizeCallback(new ShareContentCustomizeCallback() {
			...
			public void onShare(Platform platform, ShareParams paramsToShare) {
				if ("Wechat".equals(platform.getName())) {
					...
					paramsToShare
							.setUrl("http://www.meimei.yihaoss.top/singlediaryshare.php?"
					...
					paramsToShare
							.setText(babyName
									...
									+ ":"
									+ singelMsg
									+ "http://www.meimei.yihaoss.top/singlediaryshare.php?"
									+ "img_id=" + imgId + "&user_id=" + uid);
					paramsToShare.setImageUrl(singelImg);
				} else if ("QZone".equals(platform.getName())) {
					paramsToShare.setTitle(""); // title微信、QQ空间
					paramsToShare
							.setTitleUrl("http://www.meimei.yihaoss.top/singlediaryshare.php?"
									+ "img_id=" + imgId + "&user_id=" + uid);
					paramsToShare.setSite(getString(R.string.app_name)); // site是分享此内容的网站名称，仅在QQ空间使用
					paramsToShare.setText(babyName + "@" + babyBirth + ":"
							+ singelMsg);
					paramsToShare.setImageUrl(singelImg);
					paramsToShare
							.setSiteUrl("http://www.meimei.yihaoss.top/singlediaryshare.php?"
