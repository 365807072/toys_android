...
public class ToysLeaseBannerApapter extends BaseAdapter {

	private Activity context;
	private int windowWidth;
	private ArrayList<HeadListItem> headData;
	
	public ToysLeaseBannerApapter(Activity context, ArrayList<HeadListItem> headData, int windowWidth) {
		super();
