...
public class ToysLeaseHtmlConfirmOrderActivity extends BaseActivity {
	...
	protected void initView() {
		...
		webView.loadUrl("http://www.meimei.yihaoss.top/H5/toy_count/toyOrder.html?login_user_id="+Config.getUser(ToysLeaseHtmlConfirmOrderActivity.this).uid);
		urlList.add("http://www.meimei.yihaoss.top/H5/toy_count/toyOrder.html?login_user_id="+Config.getUser(ToysLeaseHtmlConfirmOrderActivity.this).uid);
...
//			startActivity(intent);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		 if ((keyCode == KeyEvent.KEYCODE_BACK) && webView.canGoBack()) {
			...
			if(urlList.size() > 1 ){
				if(urlList.get(urlList.size()-1).contains("http://www.meimei.yihaoss.top/H5/toy_count/toyOrder.html")){
					 finishThisPage();
