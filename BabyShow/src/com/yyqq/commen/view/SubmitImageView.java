 ...
 * 
 */
public class SubmitImageView extends ImageView {
	...
	public SubmitImageView(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context, attrs);
	}

	public SubmitImageView(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
	}
