 ...
 * 发布新秀秀页
 * */
public class ShowShowAddActivity extends Activity {
	...
	protected void onResume() {
		if(thisFinish){
			ShowShowAddActivity.this.finish();
			thisFinish = false;
		}
		
//		if(MyApplication.image_or_video == 0){
...
//		}
//		else if(MyApplication.image_or_video == 1){
//			findViewById(R.id.showshow_add_video_hint).setVisibility(View.GONE);
//			showshow_add_video.setVisibility(View.VISIBLE);
...
//				MyApplication.image_or_video = 0;
				...
				noScrollgridview.setVisibility(View.VISIBLE);
				msgString = msg.getText().toString().trim();
				new PopupWindows(ShowShowAddActivity.this, noScrollgridview);
...
//				MyApplication.image_or_video = 1;
				...
				noScrollgridview.setVisibility(View.GONE);
				VideoComperssUtils.intentLocationVideo(ShowShowAddActivity.this);
			}
		});
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				if (arg2 == 0) {
					if (arg2 == 10) {
						...
						msgString = msg.getText().toString().trim();
						new PopupWindows(ShowShowAddActivity.this,
								noScrollgridview);
		...
		activity_selectimg_send.setOnClickListener(new OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				if ((BimpUtil.drr.size() == 0 && TextUtils.isEmpty(PhotoEdit.imgUris)) && video_path.isEmpty()) {
					Toast.makeText(context, "图片或视频选一样吧", 0).show();
					return;
				}
				...
				if (!TextUtils.isEmpty(cateId)) {
					...
					notification = new Notification(R.drawable.icon, "正在上传",
							System.currentTimeMillis());
					notification.flags |= Notification.FLAG_ONGOING_EVENT;
					notification.setLatestEventInfo(context, "自由环球租赁", "正在上传",
							null);
						...
						public void onClick(View arg0) {
							...
							if(video_path.isEmpty()){
								...
								notification = new Notification(R.drawable.icon,
										"您的新秀秀正在发布", System.currentTimeMillis());
								notification.flags |= Notification.FLAG_ONGOING_EVENT;
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			if (msg.what == 123) {
				...
				// && Bimp.drr.size() <= 0) {
				// Toast.makeText(context, "来加张图片吧", 0).show();
				// Config.dismissProgress();
				// return;
				// }
				FinalHttp fh = new FinalHttp();
				// Log.e("fanfan", params.toString());
				fh.post(ServerMutualConfig.ImgShowV3, params,
						new AjaxCallBack<String>() {
							...
							public void onSuccess(String t) {
								...
								try {
									...
									if (isSelectWechat) {
										shareWechat(shearImg, msgString,
												BimpUtil.drr.get(0));
									}
									if (isSelectSina) {
										shareSinaWeibo(shearImg, msgString,
												BimpUtil.drr.get(0));
									}
								} catch (Exception e) {
									e.printStackTrace();
								...
								notification = new Notification(
										R.drawable.icon, "您的新秀秀已发布成功！", System
												.currentTimeMillis());
				 ...
				 * 压缩完成，开始上传
				 * */
				notification = new Notification(R.drawable.icon,"您的新秀秀正在发布", System.currentTimeMillis());
				notification.flags |= Notification.FLAG_ONGOING_EVENT;
				notification.setLatestEventInfo(context, "自由环球租赁","您的新秀秀正在发布", null);
				notificationManager.notify(2, notification);
				
				String outFilePath = "";
				if(1 < Integer.parseInt(VideoComperssUtils.VIDEO_FILE_SIZE)){
					videoTask.cancel();
					VideoComperssUtils.stopComperssService(ShowShowAddActivity.this);
				...
				VideoComperssUtils.videoUpload(ShowShowAddActivity.this, ServerMutualConfig.ImgShowV3, notificationManager, "您的新秀秀已发布成功！");
				ShowShowAddActivity.this.finish();
			}
	...
	@SuppressLint("NewApi")
	public void Send() {
		if (!TextUtils.isEmpty(msgString) && BimpUtil.drr.size() == 0
				&& PhotoEdit.imgUris == null) {
			...
			if (!TextUtils.isEmpty(cateId)) {
				...
				videoParams.put("cate_id", cateId + "");
			}
	...
	public class PopupWindows extends PopupWindow {
		public PopupWindows(Context mContext, View parent) {
			...
			Photo.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {
					Intent intent = new Intent(ShowShowAddActivity.this, PhoneAlbumActivity.class);
					intent.putExtra("tag", "isShowShowAdd");
			...
			album.setOnClickListener(new OnClickListener() {
				...
				@Override
				public void onClick(View arg0) {
					Intent intent = new Intent(ShowShowAddActivity.this,
							PhotoManager.class);
	...
	protected void onActivityResult(int requestCode, int resultCode, Intent data) {
		...
		case TAKE_PICTURE:
			...
			intent2.putExtra("tag", "isShowShowAdd");
	...
	private void shareSinaWeibo(String shearUrlImg, String msg, String path) {
		...
		sp.setText("晒晒我家宝宝最新萌照|最美的宝宝成长记录  "
				+ "http://www.meimei.yihaoss.top/share.php?" + "img_id="
		...
		if (TextUtils.isEmpty(path) || path.startsWith("http")) {
			...
			sp.setImageUrl("http://www.meimei.yihaoss.top/share.php?"
					+ "img_id=" + item.img_id + "&user_id=" + item.user_id);
		}
	...
	private void shareWechat(String shearUrlImg, String msg, String path) {
		...
		sp.setUrl("http://www.meimei.yihaoss.top/share.php?" + "img_id="
				+ item.img_id + "&user_id=" + item.user_id);
