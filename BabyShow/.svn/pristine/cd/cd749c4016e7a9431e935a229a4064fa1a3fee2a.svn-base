...
public class PostMyInterestDetail extends Activity implements
		OnPullDownListener {

	private Activity context;
	private String TAG = "fanfan_PostMyInterestDetail";
	...
	private void init() {
		...
		interest_type = getIntent().getStringExtra("interest_type");
		post_title = (TextView) findViewById(R.id.post_title);
		if ("0".equals(interest_type)) {
			post_title.setText("我参与的");
		} else {
			post_title.setText("热门活动");
		}
	...
	public void onRefresh() {
		...
		params.put("interest_type", interest_type);
//		Log.e(TAG,
//				ServerMutualConfig.PostMyInterestList + "&" + params.toString());
		ab.setTimeout(5000);
		ab.get(ServerMutualConfig.PostMyInterestList + "&" + params.toString(),
