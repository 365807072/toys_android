...
public class ToysLeaseHtmlMainHomeActivity extends BaseActivity {
	...
	public static ToysLeaseHtmlMainHomeActivity toysLeaseMainTextActivity = null;
	...
	protected void initView() {
		...
		webView.setWebViewClient(new WebViewClient() { 
			...
			public void onReceivedError(WebView view, int errorCode,
				...
				showUpdatePage();
//				Toast.makeText(ToysLeaseHtmlMainHomeActivity.this, "抱歉！找不到这个网页", Toast.LENGTH_SHORT).show();
			}
			
		});
		
		webView.loadUrl("http://www.meimei.yihaoss.top/H5/toy_count/first.html?login_user_id="+Config.getUser(ToysLeaseHtmlMainHomeActivity.this).uid);
		urlList.add("http://www.meimei.yihaoss.top/H5/toy_count/first.html?login_user_id="+Config.getUser(ToysLeaseHtmlMainHomeActivity.this).uid);
	...
	public class JSCallback{
		 ...
		 * */
		@JavascriptInterface
		public void callMethodToAllPage(){
		...
		public void callMethodToLoginPage(){
			Intent intent = new Intent(ToysLeaseHtmlMainHomeActivity.this, WebLoginActivity.class);
		...
		public String callMethodGetLoginUserId(){
			return Config.getUser(ToysLeaseHtmlMainHomeActivity.this).uid;
		}
		...
		public String callMethodIsLogin(){
			if(!MyApplication.getVisitor().equals("0")  || Config.getUser(ToysLeaseHtmlMainHomeActivity.this).uid.equals("")){
				return "0"; // 未登录
			}else{
				return "1"; // 已登陆
			}
		...
		public void callMethodToToysList(String toys_type){
			if(null == toys_type || toys_type.equals("") || toys_type.equals("undefined")){
				Toast.makeText(ToysLeaseHtmlMainHomeActivity.this, "找不到这组玩具哦~", 3).show();
				return;
			}
...
//			startActivity(intent);
		...
		public void callMethodToToysDetail(String toys_id){
			if(null == toys_id || toys_id.equals("") || toys_id.equals("undefined")){
				Toast.makeText(ToysLeaseHtmlMainHomeActivity.this, "找不到这个玩具哦~", 3).show();
				return;
			}
			Intent intent = new Intent(ToysLeaseHtmlMainHomeActivity.this, ToysLeaseHtmlDetailActivity.class);
		...
		public void callMethodToToysOrderDetail(String order_id){
			if(null == order_id || order_id.equals("") || order_id.equals("undefined")){
				Toast.makeText(ToysLeaseHtmlMainHomeActivity.this, "找不到这个订单哦~", 3).show();
				return;
			}
			Intent intent = new Intent(ToysLeaseHtmlMainHomeActivity.this, ToysLeaseHtmlOrderToysDetailActivity.class);
		...
		public void callMethodToPostDetail(String img_id){
			if(null == img_id || img_id.equals("") || img_id.equals("undefined")){
				Toast.makeText(ToysLeaseHtmlMainHomeActivity.this, "找不到这个话题哦~", 3).show();
				return;
			}
			Intent intent = new Intent(ToysLeaseHtmlMainHomeActivity.this, MainItemDetialActivity.class);
		...
		public void showToast(String toastStr) {
			Toast.makeText(ToysLeaseHtmlMainHomeActivity.this, toastStr, Toast.LENGTH_LONG).show();
		}
		...
		public void callMethodToSearch() {
			Intent intent = new Intent(ToysLeaseHtmlMainHomeActivity.this, ToysLeaseHtmlSearchActivity.class);
			startActivity(intent);
		}
		...
		public void callMethodToInvite() {
			Intent intent = new Intent(ToysLeaseHtmlMainHomeActivity.this, InviteFriendActivity.class);
			startActivity(intent);
		}
		...
		public void callMethodToWeb(String url){
			Intent intent = new Intent(ToysLeaseHtmlMainHomeActivity.this, MainItemDetialWebActivity.class);
		...
		public void callMethodToCategory(String category_id){
			Intent intent = new Intent(ToysLeaseHtmlMainHomeActivity.this, ToysLeaseHtmlCategoryActivity.class);
	...
	public boolean onKeyDown(int keyCode, KeyEvent event) {
		 if ((keyCode == KeyEvent.KEYCODE_BACK) && webView.canGoBack()) {
			...
			if(urlList.size() > 1 ){
				if(urlList.get(urlList.size()-1).contains("http://www.meimei.yihaoss.top/H5/toy_count/first.html")){
					 finishThisPage();
	...
	private void finishThisPage(){
		 ToysLeaseHtmlMainHomeActivity.this.finish();
	}
