...
public class GrowReviewList extends Activity implements OnPullDownListener {
	...
	public OnClickListener reviewClick = new OnClickListener() {
		...
		public void onClick(View v) {
			if (edit_review.getText().toString().trim().length() > 0) {
				...
				params.put("demand",edit_review.getText().toString().trim());  
				params.put("img_id", img_id);    
				ab.post(ServerMutualConfig.DiaryReview, params,
		...
		public void onClick(View v) {
			if (custom_face_layout.view.getVisibility() == View.VISIBLE) {
				...
				((InputMethodManager) getSystemService(INPUT_METHOD_SERVICE))
						.hideSoftInputFromWindow(GrowReviewList.this
...
//		android.util.Log.e("fanfan", ServerMutualConfig.DiaryReviewList + "&" + params.toString());
		ab.get(ServerMutualConfig.DiaryReviewList + "&" + params.toString(),
				new AbStringHttpResponseListener() {
					@Override
					public void onSuccess(int statusCode, String content) {
						super.onSuccess(statusCode, content);
						...
						builder.setNegativeButton("删除",
								new DialogInterface.OnClickListener() {
									...
									public void onClick(DialogInterface dialog,
										...
										fh.post(ServerMutualConfig.DelDiaryReview,
												params,
